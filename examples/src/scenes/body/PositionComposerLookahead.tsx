...
// baseHeight - bobAmplitude - ball radius is the ball's lowest point at any angle on the loop; clutter
// anywhere near the loop stays well below that
 ...
 *  speed change, and `lookaheadIgnoreY` drops the vertical half of it. */
      ...
      <Klipp>
        <VirtualCamera
          ...
          <Body.PositionComposer
            ...
            debug={debug}
          />
          <SpectatorFrustum maxDistance={cameraDistance + loopRadius + 4} />
        </VirtualCamera>
      </Klipp>
    </>
  );
