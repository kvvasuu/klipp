...
function SpectatorInset({ element }: { element: HTMLDivElement | null }) {
  ...
  return <OrbitControls camera={spectatorCamera} domElement={element} target={[0, 2, 0]} makeDefault={false} />;
}
 ...
 *  from outside. */
export function BaseScene({ children, insetElement }: { children: ReactNode; insetElement: HTMLDivElement | null }) {
  return (
    <>
      <SpectatorInset element={insetElement} />
